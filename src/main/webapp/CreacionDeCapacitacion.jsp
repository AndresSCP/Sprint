	...
	<div class="container">
		<form action="SvCrearCapacitacion" method="post">
			...
			<div class="form-group">
				<label for="nombreCapacitacion">Nombre de capacitacion:</label> <input
					type="text" id="nombre" name="nombreCapacitacion"
			...
			<div class="row">
				<div class="col-md-3">
					<label for="dia" class="form-label">Dia:</label> <select
						class="form-select" id="dia" name="dia" required>
				...
				<div class="col-md-3">
					<label for="hora" class="form-label">Hora:</label> <input
						type="time" id="hora" name="hora" class="form-control" required>
				</div>
				<div class="col-md-3">
					<label for="lugar" class="form-label">Lugar:</label> <select
						class="form-select" id="lugar" name="lugar" required>
