...
<!--creando una tabla para mostrar un listado de clientes, donde cada fila representar� un cliente y cada columna de la tabla mostrar� informaci�n  del cliente. -->
