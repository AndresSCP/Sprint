...
El proyecto se desarrolló mediante un enfoque de desarrollo ágil, en el que se utilizó un sistema de control de versiones (Git y Trello) para mantener un seguimiento organizado del progreso del trabajo en equipo y del código fuente. Para asegurar su funcionamiento, la aplicación se implementó en un servidor web (Apache Tomcat) en el entorno de programación Eclipse.
La aplicación fue diseñada siguiendo una orientación a objetos en Java y utilizando el patrón de diseño MVC para separar la lógica de presentación de la lógica de negocio. Se llevaron a cabo pruebas automatizadas y manuales para garantizar la calidad del código y la funcionalidad de la aplicación. Además, se realizó una evaluación de seguridad con el fin de identificar y solucionar posibles vulnerabilidades en la aplicación.

Integrantes:

Integrantes	            git

Jose Zamora	            @ zamorajg
Matias Calderon	        @matcalderon
Andres	                @AndresSCP
David Morales Palta     @AnotherDyslexicDev
